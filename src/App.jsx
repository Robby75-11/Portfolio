...
const App = () => {
  ...
  const projects = [
    ...
    },
    {
      title: "Netflix-Movie",
      description:
        "Una riproduzione fedele della homepage di Netflix, focalizzata su card cinema.L'app consente di aggiungere i film a una lista personale, cancellarlo tramite i pulsanti dedicati (+Lista, Delete) e, cliccando su una card, visualizzare la descrizione completa del film. Realizzato con Bootstrap, javascript, React.",
